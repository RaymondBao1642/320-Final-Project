...
```{r gdp, fig.width = 10, fig.height=15, include = TRUE}
gdp_plot <- gdp %>%
...
```{r time, fig.width = 10, fig.height=15, include = TRUE}
time_plot <- time_df %>%
...
```{r sex, fig.width = 10, fig.height=15, include = TRUE}
...
```{r age, fig.width = 10, fig.height=15, include = TRUE}
